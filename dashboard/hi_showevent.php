...
$idE = $_GET['id_event'];
$query = "SELECT * FROM data_event WHERE id_event = '$idE'";
                  ...
                  <form class="col s12" action="../proses/proses_terbitEvent.php" method="post">
                    <div class="row">
                      ...
                      <div class="input-field col s12">
                        <input name="nama" id="nama" type="text" class="validate" value="<?php echo $row[3]; ?>">
                    ...
                    <div class="row">
                      <div class="input-field col s6">
                        <input name="p_jawab" id="p_jawab" type="text" class="validate" value="<?php echo $row[5]; ?>">
                        <label for="p_jawab">Penanggung Jawab Event</label>
                      </div>
                      <div class="input-field col s6">
                        <input name="k_jawab" id="k_jawab" type="text" class="validate" value="<?php echo $row[6]; ?>">
                      ...
                      <div class="white-text input-field col s12">
                        ...
                        *Klik pada peta untuk memilih lokasi event
                        <input name="l_event" id="l_event" type="text" class="validate" hidden="true" value="<?php echo $row[7]; ?>">
                      </div>
                    </div>
                    <input type="submit" name="submit" class="right waves-light btn" style="margin-left:10px;" value="Simpan & Terbitkan Event">
                    <input type="submit" name="submit" class="right waves-light btn" style="margin-left:10px;" value="Simpan Event">
                  </form>
                </table>
              </div>
            </div>
