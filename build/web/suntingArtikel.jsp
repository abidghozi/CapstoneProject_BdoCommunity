<%-- 
    Document   : suntingArtikel
    Created on : Nov 27, 2016, 9:25:38 AM
    Author     : Gerungan
--%>
...
<%    System.out.println(user);
    ...
    result.first();
    ResultSet result2 = func_SuperAdmin.getArtikelKomunitasAllData();
%>
<!DOCTYPE html>
<html>
    <head>
        ...
        <div class="row">
            ...
            <header class="col s2">
                <ul style="width:240px; margin-top:65px;" class="side-nav fixed">
                    ...
                    <li><a href="#" class="grey lighten-1">Sunting Artikel</a></li>
                                            ...
                                            if (result2 != null) {
                                                while (result2.next()) {
                                                    out.print(""
                                                            ...
                                                            + " | "
                                                            + "<a href='func_Artikel?idA=" + result2.getString(1) + "&type=approve'>Approve</a></th>"
                                                            + "</tr>");
                                                }
                                            } else {
                                        %>
