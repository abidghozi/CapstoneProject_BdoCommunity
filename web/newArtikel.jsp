<%-- 
    Document   : newArtikel
    Created on : Nov 25, 2016, 8:21:53 PM
    Author     : Gerungan
--%>
...
<html>
    ...
    <body>
        ...
        <script>
    function back() {
        window.location = "redirect_dashlow";
    }
                                    ...
                                    <div class="card-panel grey lighten-5 s12" style="padding:20px;">
                                        <div class="row">
                                            <div class="input-field col s12">
                                                <input name="judulArtikel" id="judulArtikel" type="text" class="validate" required="true">
                                        ...
                                        <div class="input-field col s12 hide">
                                            <textarea name="dtArtikel" id="dtArtikel"></textarea>
                                        </div>

                                        <div style="padding: 20p;">
                                            <div class="row">
                                                <div class="input-field col s12">
                                                    <input name="tagArtikel" id="tagArtikel" type="text" class="validate" required="true">
                                                    <label for="tagArtikel">Tag Artikel</label>
                                                </div>
                                                <div class="input-field col s12 hide">
                                                    <input name="type" id="type" type="text" class="validate" value="new">
                                                </div>
                                                <div class="input-field col s12 hide">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col s3">
                                                    <input onclick="getVal();" type="submit" value="Simpan Artikel" class="modal-action modal-close waves-effect waves-green indigo btn">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
